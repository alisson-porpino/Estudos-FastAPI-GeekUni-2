...
async def put_curso(curso_id: int, curso: CursoSchema, db: AsyncSession = Depends(get_session)):
    async with db as session:
        ...
        print(f"Tipo do objeto retornado por scalar_one_or_none: {type(curso_up)}")
...
async def delete_curso(curso_id: int, db: AsyncSession = Depends(get_session)):
    async with db as session:
        ...
        print(f"Tipo do objeto retornado por scalar_one_or_none em delete_curso: {type(curso_del)}")  # Adiciona este log
